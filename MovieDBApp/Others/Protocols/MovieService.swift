...
protocol MovieService {
    ...
    func fetchSimilarMovies(from endpoint: Endpoint, movie: Movie, params: [String: String]?, successHandler: @escaping (_ response: MoviesResponse) -> Void, errorHandler: @escaping(_ error: Error) -> Void)
}
